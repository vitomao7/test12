...
<body>
    <div class="container-fluid">
        ...
        <table class="table table-striped">
            ...
            <c:forEach varStatus="i" var="ses" items="${requestScope.model.models }">
           
            <tr>
                <td><input type="checkbox" name="userItem"/><input type="hidden" value="${ses.SESSION_ID }"/></td>
                <td>${i.count }</td>
                <td>${ses.CINEMA_NAME }</td>
                <td>${ses.HALL_NAME }</td>
                <td>${ses.MOVIE_NAME }</td>
                <td>${ses.SESSION_LAN }</td>
                <td>${ses.SESSION_PRICE }</td>
                <td>${ses.SESSION_DATE }</td>
                <td>${ses.SESSION_START }</td>
                <td>${ses.SESSION_END }</td>
            </tr>
            </c:forEach>		    	
        ...
        <ul class="pagination">
            ...
            <li><a href="SessionInfoServlet.do?nowPage=1&pageCount=10">首页</a></li>
            ...
            <c:choose>
            	...
            	<c:otherwise>
            	<li><a href="SessionInfoServlet.do?nowPage=${requestScope.model.nowPage-1 }&pageCount=10">&laquo;</a></li>
            	</c:otherwise>
            </c:choose>
            ...
            <c:forEach var="x" begin="1" end="${requestScope.model.totalPages }">
            	<c:choose>
            		<c:when test="${requestScope.model.nowPage == x }">
            		 <li class="active"><a  href="SessionInfoServlet.do?nowPage=${x }&pageCount=10">${x }</a></li>
            		</c:when>
            		<c:otherwise>
            		<li><a href="SessionInfoServlet.do?nowPage=${x }&pageCount=10">${x }</a></li>
            		</c:otherwise>
            	</c:choose>
 			...
 			<c:choose>
 				...
 				<c:otherwise>
 					<li><a href="SessionInfoServlet.do?nowPage=${requestScope.model.nowPage+1 }&pageCount=10">&raquo;</a></li>
 				</c:otherwise>
 			</c:choose>
            ...
            <li><a href="SessionInfoServlet.do?nowPage=${requestScope.model.totalPages }&pageCount=10">尾页</a></li>
        </ul>
