...
<body>
    <div class="container-fluid">
        ...
        <table class="table table-striped">
            ...
            <c:forEach var="user" items="${requestScope.model.models }">
           
            <tr>
                <td><input type="checkbox" name="userItem"/></td>
                <td>${user.userId }</td>
                <td>${user.userName }</td>
                <td>
        ...
        <ul class="pagination">
            ...
            <li><a href="UserInfoServlet.do?nowPage=1&pageCount=10">首页</a></li>
            ...
            <c:choose>
            	...
            	<c:otherwise>
            	<li><a href="UserInfoServlet.do?nowPage=${requestScope.model.nowPage-1 }&pageCount=10">&laquo;</a></li>
            	</c:otherwise>
            </c:choose>
            ...
            <c:forEach var="x" begin="1" end="${requestScope.model.totalPages }">
            	<c:choose>
            		<c:when test="${requestScope.model.nowPage == x }">
            		 <li class="active"><a  href="UserInfoServlet.do?nowPage=${x }&pageCount=10">${x }</a></li>
            		</c:when>
            		<c:otherwise>
            		<li><a href="UserInfoServlet.do?nowPage=${x }&pageCount=10">${x }</a></li>
            		</c:otherwise>
            	</c:choose>
 			...
 			<c:choose>
 				...
 				<c:otherwise>
 					<li><a href="UserInfoServlet.do?nowPage=${requestScope.model.nowPage+1 }&pageCount=10">&raquo;</a></li>
 				</c:otherwise>
 			</c:choose>
            ...
            <li><a href="UserInfoServlet.do?nowPage=${requestScope.model.totalPages }&pageCount=10">尾页</a></li>
        </ul>
