...
public class MovieInfoServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		PageModel<Map<String, String>> pageModel = new MovieServiceImpl().queryMoviePage(nowPage, pageCount);
		
		
		req.setAttribute("model", pageModel);
		req.getRequestDispatcher(resp.encodeURL("movieinfo.jsp")).forward(req, resp);
	}
